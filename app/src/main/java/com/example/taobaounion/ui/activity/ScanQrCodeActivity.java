...
//对ActivityScanerCode的源码进行修改，替换为我们自己想要的界面
public class ScanQrCodeActivity extends ActivityBase {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.taobaounion.R.layout.activity_scanner_qr_code);
    ...
    public void handleDecode(Result result) {
        ...
        LogUtils.d(ScanQrCodeActivity.this,"二维码/条形码 扫描结果-->" + result.getText());

        //此处对扫描结果的处理为弹窗，不是我们想要的
        //重新处理扫描结果
        /*if(result1.contains("tb.cn")){
            ToastUtils.showToast("扫描成功");
            //是淘宝的二维码
            //跳转到淘口令界面
            TicketUtils.toTicketActivity(this, new IBaseInfo() {
                @Override
        ...
        if (mScannerListener == null) {
            ...
            LogUtils.d(this,"initDialogResult(result);");
        } else {
